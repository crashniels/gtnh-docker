...
# get gtnh
RUN wget https://downloads.gtnewhorizons.com/ServerPacks/GT_New_Horizons_2.5.1_Server_Java_17-21.zip
RUN unzip GT_New_Horizons_2.5.1_Server_Java_17-21.zip -d /gtnh
RUN rm GT_New_Horizons_2.5.1_Server_Java_17-21.zip
